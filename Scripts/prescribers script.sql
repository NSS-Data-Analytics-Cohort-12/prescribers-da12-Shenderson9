...
-- SELECT nppes_provider_first_name, nppes_provider_last_org_name, specialty_description, SUM(total_claim_count + total_claim_count_ge65)
-- FROM prescriber
...
-- SELECT
-- 	prescriber.specialty_description AS specialty
-- 	,COUNT(drug.opioid_drug_flag) AS count_opioid
-- FROM prescriber
-- LEFT JOIN prescription
-- USING(npi)
-- FULL JOIN drug
...
-- SELECT generic_name, ROUND(total_drug_cost/total_day_supply, 2) AS day_cost
-- FROM drug
-- INNER JOIN prescription
-- USING(drug_name)
...
-- CASE WHEN opioid_drug_flag = 'Y' THEN 'opioid'
-- WHEN antibiotic_drug_flag = 'Y' THEN 'antibiotic'
-- ELSE 'neither' END AS drug_type,SUM(total_drug_cost) ::MONEY
-- FROM drug
-- LEFT JOIN prescription
-- USING(drug_name)
-- GROUP BY drug_type
